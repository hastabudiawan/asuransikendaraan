...
<div class="page-wrapper chiller-theme toggled">
  ...
  $total = $_POST['total'];  
  $simpan = mysqli_query($koneksi,"INSERT INTO premi(kodepremi,kodenasabah,nomorkendaraan,tipepolis,tanggal,total) VALUES('$kodepremi','$kodenasabah','$nomorkendaraan','$tipepolis','$tanggal','$total')");
  if(!$simpan ){
  echo "<script>alert('Gagal di tambahkan!');document.location='tambahpremi.php'</script>";
  } else{
  echo "<script>alert('Data berhasil di tambahkan!');document.location='vpremi.php'</script>";
  }
  }
  ?>
        ...
        <div class="form-group col-md-12">
            <div class="card">
              <div class="card-header">
                <h5>Tambah Data Premi</h5>
              </div>
              <div class="card-body">
                <form method="post" action="tambahpremi.php">
                  <div class="row">       
                    <div class="col-sm-6 offset-sm-3">                      
                      <div class="form-group">
                        <label>Kode Premi</label>
                        <input type="text" name="kodepremi" class="form-control" required="true">
                      </div>          
                      <div class="form-group">
