...
<div class="page-wrapper chiller-theme toggled">
  ...
  $data = mysqli_query($koneksi,"select * from polis where kodepolis='$kodepolis'");
        ...
        <div class="form-group col-md-12">
            <div class="card">
              <div class="card-header">
                <h5>Ubah Data Polis</h5>
              </div>
              <div class="card-body">
                <form method="post" action="datapolisaksi.php">
                  <div class="row">
                    <div class="col-sm-6 offset-sm-3">
                      <a href="vpolis.php">Kembali</a>          
                      <div class="form-group">
                        <input type="hidden" name="kodepolis" class="form-control" required="true" value="<?php echo $d['kodepolis'];?>">
                      </div>                    
                      <div class="form-group">
